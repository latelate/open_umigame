...
if (!empty($data)){
?>
<div class="black-bar margin_b50"><h1><?php echo h($data["User"]["name"])?>さんの出題した問題<?php echo $this->Paginator->counter(array('format' => '(%count%問)'));?></h1></div>
<?php
...
?>
<div class="black-bar margin_b50"><h1>問題情報がありません。</h1></div>
<?php
}
 ?>
