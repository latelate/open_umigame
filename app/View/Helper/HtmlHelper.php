 ...
 */
	...
	function dateFormat($date,$format = "y年m月d日H時i分s秒") {
	    return date($format,strtotime($date));
	}
	function sss($date,$format = "s") {
	    return date($format,strtotime($date));
	}
	function iii($date,$format = "i") {
	    return date($format,strtotime($date));
	}
	function hhh($date,$format = "H") {
	    return date($format,strtotime($date));
	}
	function ddd($date,$format = "d") {
	    return date($format,strtotime($date));
	}
	function mmm($date,$format = "m") {
	    return date($format,strtotime($date));
	}
	function yyy($date,$format = "Y") {
	    return date($format,strtotime($date));
	}
	function www($date,$format = "w") {
	    return date($format,strtotime($date));
	}
	function df($date,$format = "y年m月d日 H:i") {
	    return $this->dateFormat($date,$format);
	}
	function mdhi($date,$format = "m月d日 H:i") {
	    return $this->dateFormat($date,$format);
	}
	function dfj($date,$format = "y年m月d日") {
	    return $this->dateFormat($date,$format);
	}
	function koj($date,$format = "y年m月d日") {
	    return $this->dateFormat($date,$format);
	}
	function YmdH($date,$format = "Y年m月d日H時") {
	    return $this->dateFormat($date,$format);
	}
	function Ym($date,$format = "y年m月") {
	    return $this->dateFormat($date,$format);
	}
	function dft($date,$format = "d日H時i分") {
	    return $this->dateFormat($date,$format);
	}
	function dlo($date,$format = "m月d日") {
	    return $this->dateFormat($date,$format);
	}
	function angou($date,$format = "Ymd") {
	    return $this->dateFormat($date,$format);
	}
}
